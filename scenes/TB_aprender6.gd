...
func _pressed():
	print("presseddd")
	get_parent().get_parent().get_parent().get_parent().get_parent().get_node("popup_aprender").set("texture", load("res://TELAS/Aprendizado/mosquito/doencas_transmitidas.jpg"))
